...
const apiRequestUrlText = `POST | ${import.meta.env.VITE_API_URL}/generate`;
const apiRequestBodyText = `
{
    //required - the url for which short url needs to be generated
    url: "https://mysite.com"
}
`;

const apiSuccessResponseText = `
{
    //original url
    url: "https://mysite.com",
    //shortened url
...
export default function ApiIntegrationModal({open, setOpen, url, shortUrl}) {
                      ...
                      <div className="mt-2">
                        ...
                        <div className="mt-3">
                            <Prism.Tabs defaultValue="successResponse">
                                ...
                                <Prism language="json" noCopy={true} colorScheme='dark'>{apiSuccessResponseText}</Prism>
                            </Prism.Tabs>
                        </div>
                      </div>
                    </div>
